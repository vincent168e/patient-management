...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        CfnHealthCheck authDbHealthCheck = createDbHealthCheck(authServiceDb, "AutServiceDBHealthCheck");
        ...
        FargateService authService = createFargateService(
                ...
                List.of(4005),
                authServiceDb,
                Map.of("JWT_SECRET", "571ac29b171cf9781fc4aa85f8056e177f82f249012ea34175a48fedf9a0e0a0")
        );
